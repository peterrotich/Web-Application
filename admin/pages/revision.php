  ...
  <body class="skin-blue">
    ...
    <?php include('includes/sidebar.php'); ?>
      ...
      <div class="content-wrapper">
        ...
        <div id = "ProcessingRevision" style="margin-left:2%">
            Processing...
        </div>
        </section>
        <!-- Main content -->
    ...
    <!-- Processing Orders In Revision-->
    <script type="text/javascript">
    var resreshId = setInterval(function()
    {
    $('#ProcessingRevision').show().load('http://localhost/customwritingpros/admin/pages/processes/revision.php');
