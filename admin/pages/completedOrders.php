  ...
  <body class="skin-blue">
    ...
    <?php include('includes/sidebar.php'); ?>
      ...
      <div class="content-wrapper">
        ...
        <div id = "ProcessCompletedOrders" style="margin-left:2%">
            Processing....
        </div>
        </section>
        <!-- Main content -->
    ...
    {
    $('#ProcessCompletedOrders').show().load('http://localhost/customwritingpros/admin/pages/processes/completedOrders.php');
