  ...
  <body class="skin-blue">
    ...
    <?php include('includes/sidebar.php'); ?>
      ...
      <div class="content-wrapper">
        ...
        <div id = "ProcessDeletedOrders" style="margin-left:2%">
            Processing....
        </div>
        </section>
        <!-- Main content -->
    ...
    {
    $('#ProcessDeletedOrders').show().load('http://localhost/customwritingpros/admin/pages/processes/archive.php');
