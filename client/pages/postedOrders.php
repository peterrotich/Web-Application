...
<div class="container-fluid">
    <div class="row">
        ...
        <a href="JavaScript:if(confirm('Request A specific Writer?')==true){window.location='requestWriter.php?orderId=<?=$row["orderId"];?>';}">
        <i class="fa fa-user fa-fw" style="font-size:20px;"></i></a>

        <a href="JavaScript:if(confirm('View this order?')==true){window.location='viewOrder.php?orderId=<?=$row["orderId"];?>';}">
        <i class="fa fa-search-plus fa-fw" style="font-size:20px;"></i></a>

        <a href="JavaScript:if(confirm('Delete this order?')==true){window.location='deleteOrder.php?orderId=<?=$row["orderId"];?>';}">
        <i class="fa fa-trash-o fa-fw" style="font-size:20px;"></i></a>
