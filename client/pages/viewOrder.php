...
<?php include('includes/sidebar.php'); ?>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Client Panel - <small>Order: <?php echo $id;?> </small></h1>   
                    </div>
            ...
            <form id = "posted_orders" name = "posted_orders" action="" method="POST">
                ...
                <div id="collapseOne" class="panel-collapse collapse in">
                    <div class="panel-body">
                        ...
                        <button type="button" class="btn btn-success"><i class="fa fa-plus-circle  fa-fw"></i> More Files</button></a>                            </td>
                          </tr>
                        </table>                                    
                    </div>
                </div>
