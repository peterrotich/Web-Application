...
<head>
    ...
    <title>Custom Writing Pros || Forgot Password</title>
...
<div id = "body-content">
<h1 align = "Center"><i class="fa fa-unlock wow bounceIn text-success"></i> Reset Your Password</h1>
<div id = "logIn">
    <b>Please Enter Your Email Address</b>
    <hr/>
    <form id = "forgotPassword" method = "POST" action = "forgotPassword.php">
        <table width = "50%" align = "center" cellspacing="20" border = "0">
            <tr>
                ...
                <td align = "right">
                    <button type = "reset" name="reset" class="btn btn-outline btn-primary" value = ""><i class="fa fa-key wow bounceIn"></i> Reset Password</button>
                </td>
            </tr>
        </table>
    </form>
